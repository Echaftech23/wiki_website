              ...
              <div class="rounded-sm rounded-t-md overflow-hidden bg-white shadow-sm">
                  ...
                  <form action="updateWiki" method="post" enctype="multipart/form-data">
                      <label for="fileInput" class="block rounded-md overflow-hidden cursor-pointer">
                          <img id="thumbnailPreview" src="public/img/<?php echo $wiki->getImage() ?>" class="w-full h-60 md:h-96 object-cover transform hover:scale-110 transition duration-500" alt="">
                      ...
                      <div class="p-4 pb-5">
                          ...
                          <textarea name="title" placeholder="Title of Your Article" class="w-full border-0 outline-none focus:ring-0 mb-8 resize-none block text-xl md:text-3xl md:font-semibold font-semibold text-gray-700 hover:text-blue-500 transition font-roboto" style="height:auto; overflow-y:hidden;" oninput="this.style.height = 'auto'; this.style.height = (this.scrollHeight) + 'px';"><?= $wiki->getTitle() ?></textarea>
                          <textarea rows="10" id="areaContent" name="content" placeholder="Add the Description of The Article" class="w-full border-0 resize-none outline-none focus:ring-0 block text-gray-500 text-sm"><?= $wiki->getContent() ?></textarea>
                          <input type="hidden" name="id" value="<?php echo $wiki->getId(); ?>">

                          <?php $tagsTable = $wiki->getTags() ?>
                          <div class="flex items-center flex-wrap gap-2 mt-14">
                          ...
                          <div class="mt-3 flex items-center justify-between space-x-4">
                              ...
                              <div>
                                  <a href="addWiki" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-3xl border border-gray-200 text-sm font-medium px-5 py-2 mr-2 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">
                                      Cancel
                                  </a>
                                  <button name="editwiki" type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-3xl text-sm px-5 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                      Submit
                                  </button>
                              </div>
                          </div>
