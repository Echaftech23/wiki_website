        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
                <div class="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
                    <div class="flex justify-between mb-6">
                        <div>
                            ...
                            <div class="text-sm font-medium text-gray-400">published Wikis</div>
                        </div>
                        <div class="dropdown">
                    ...
                    <div class="flex items-center">
                        <div class="w-full bg-gray-100 rounded-full h-4">
                            <div class="h-full bg-blue-500 rounded-full p-1" style="width: 70%;">
                                <div class="w-2 h-2 rounded-full bg-white ml-auto"></div>
                            </div>
                        </div>
                        <span class="text-sm font-medium text-gray-600 ml-4">70%</span>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
                    ...
                    <div class="flex items-center">
                        <img src="public/img/user-1.jpg" alt="" class="w-8 h-8 rounded-full object-cover block">
                        <img src="public/img/user-2.jpg" alt="" class="w-8 h-8 rounded-full object-cover block -ml-3">
                        <img src="public/img/user-3.jpg" alt="" class="w-8 h-8 rounded-full object-cover block -ml-3">
                        <img src="public/img/user-4.jpg" alt="" class="w-8 h-8 rounded-full object-cover block -ml-3">
                        <img src="public/img/user-5.jpg" alt="" class="w-8 h-8 rounded-full object-cover block -ml-3">
                    </div>
                </div>
                ...
                <div class="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
                    <div class="flex justify-between mb-6">
                        <div>
                            <div class="text-2xl font-semibold mb-1"><span class="text-base font-normal text-gray-400 align-top"></span>2,345</div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                <div class="bg-white border border-gray-100 shadow-md shadow-black/5 p-6 rounded-md">
                    <div class="flex justify-between mb-4 items-start">
                        <div class="font-medium">Manage Wikis</div>
                        <div class="dropdown">
                            <button type="button" class="dropdown-toggle text-gray-400 hover:text-gray-600"><i class="ri-more-fill"></i></button>
                            <ul class="dropdown-menu shadow-md shadow-black/5 z-30 hidden py-1.5 rounded-md bg-white border border-gray-100 w-full max-w-[140px]">
                                <li>
                    ...
                    <div class="flex items-center mb-4 order-tab">
                        <button type="button" data-tab="order" data-tab-page="completed" class="bg-gray-50 text-sm font-medium text-gray-400 py-2 px-4 hover:text-gray-600">published</button>
                        <button type="button" data-tab="order" data-tab-page="canceled" class="bg-gray-50 text-sm font-medium text-gray-400 py-2 px-4 rounded-tr-md rounded-br-md hover:text-gray-600">archived</button>
                    </div>
